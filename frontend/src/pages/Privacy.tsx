	...
	return (
		<Row>
			<Col xs={22} lg={16} className="m-auto">
				<Card>
					<h2 style={{ fontSize: "2em" }}>Privacy Policy</h2>
					<p>
						Your privacy is important to us. It is BurnAfterReading&apos;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://www.burnafterreading.xyz, and other sites we own and operate.
					</p>
					<p>
						This policy is effective as of 18 April 2021 and was last updated on 18 April 2021.
					</p>
					...
					<h2>Contact Us</h2>
					<p>
						For any questions or concerns regarding your privacy, you may contact us using the following details: burnafterreading.xyz@gmail.com
					</p>
				</Card>
			</Col>
		</Row>
